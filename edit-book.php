...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE books SET category_id = '$category_id', name = '$name', price = '$price', discount_price = '$discount', image = '$path' WHERE id = '$id'";
            ...
            <div class="form-content">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" id="price" placeholder="Enter price" value="
                        <?php
                        $sql = "SELECT * FROM books WHERE id = '$id'";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($result);
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="discount_price" id="price" placeholder="Enter Dis price" value="
                        <?php
                        $sql = "SELECT * FROM books WHERE id = '$id'";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($result);
